...
var workerId = parseInt(system.args[system.args.length-3]);
var workerData = {
    id : workerId
};

// location of the users worker file
var workerFile = system.args[system.args.length-2];
...
var REQUESTS_BEFORE_WORKER_RESTART = system.args[system.args.length-1];;
